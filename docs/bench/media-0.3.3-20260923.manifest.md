...
- date: 2026-09-23T00:59:55-04:00
...
- flea launch line: FLEA_BIN=/home/gm/Work/claude/flea-033-field/cand/target/release/flea FLEA_UI=/home/gm/Work/claude/flea-033-field/cand/ui XDG_STATE_HOME=/tmp/flea-bench-state.ER42DS setsid nohup /home/gm/Work/claude/flea-033-field/cand/target/release/flea --gui /home/flea-sandbox/flea-media-btrfs
- load average at start: 0.49 1.66 1.94
- waited 30 seconds for the box to go idle before starting
...
set previewer /tmp/tmp.VWcXf17AfA/lf/previewer.sh
set cleaner /tmp/tmp.VWcXf17AfA/lf/cleaner.sh
```
...
- ended: 2026-09-23T01:15:06-04:00
- load average at end: 1.68 2.21 2.23
...
- pcmanfm produced mkv 100, mp4 400, png 88, webm 100; refused nothing; never attempted heic 200, jpg 600, png 112, txt 200, webp 200
...
- dolphin produced jpg 224, mkv 75, mp4 300, webm 75; refused nothing; never attempted heic 200, jpg 376, mkv 25, mp4 100, png 200, txt 200, webm 25, webp 200
...
- the ranked rows differ in thumbnail work by 16x, from 42 to 688, so their settle times are not ranked against each other
...
This media arm is a second pass the same night. The first ran with TRANSIENT_ID at its default, which counts strata by a per-render file v0.19.0 no longer writes, so it left strata unranked and was discarded.
